...
\'Section: Environments' : 'COMMENT',
    ...
    \'list' : "\\begin{enumerate}\<CR>\\item <+++>\<CR>\\end{enumerate}",
    \'eq'  : "\\begin{displaymath}\<CR><+++>\<CR>\\end{displaymath}",
    \'eqn' : "\\begin{equation}\\label{<+++>}\<CR><++>\<CR>\\end{equation}",
    \'align' : "\\begin{align*}\<CR><+++>\<CR>\\end{align*}",
    \'title' : "\\title{ <+++>  } \n\\author{Noah Gamboa -- \\texttt{ngamboa@stanford.edu} -- 05939839} \n\\date{\\today} \n\\maketitle\n<++>",
    \'newdoc' : "\\documentclass[12pt]{article} \n\n\\setlength{\\columnsep}{0.1pc}\n\n\\begin{document} \n<+++> \n\\end{document}",
    \'listing': "\\begin{lstlisting}\<CR><+++>\<CR>\\end{lstlisting}",
    \
